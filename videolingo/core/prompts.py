...
4. Note: the audio may mix multiple languages (e.g., English and Korean); if any text is not in {src_language}, translate it into {TARGET_LANGUAGE} as well, never skip or leave it untranslated
...
6. Note: the audio may mix multiple languages (e.g., English and Korean); if any text is not in {src_language}, translate it into {TARGET_LANGUAGE} as well, never skip or leave it untranslated
