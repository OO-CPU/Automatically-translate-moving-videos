    ...
    with st.expander(t("Subtitles Settings"), expanded=True):
        ...
        if audio_only:
            ...
            show_source = st.toggle(
                t("Bilingual Subtitles"),
                value=load_key("subtitle.show_source_subtitle"),
                help=t("Show original English subtitles alongside Chinese"),
            )
            if show_source != load_key("subtitle.show_source_subtitle"):
                update_key("subtitle.show_source_subtitle", show_source)
                st.rerun()
